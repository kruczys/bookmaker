    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bet', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='bookmaker.bet')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bookmaker.userprofile')),
            ],
        ),
    ]
